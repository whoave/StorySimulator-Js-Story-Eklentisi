...
class storySimulator {
    ...
    create(a, b, c, d, e) {
        ...
        <div onclick="ot('${a}',${f})" class="storysimulator" >
            <img  title="${e}" alt="${e}" src="${b}" />
        </div>
        ...
        c.forEach((b) => {
            ...
            $("#" + a).html($("#" + a).html() + `<div id="${a + "x" + d}" style="height:${c}px;background-image:url('${b}');"></div>`), d++;
        });
    }
}
